    ...
    static public class KhachHang_DAL
    {
        ...
        static public bool updateKhachHang(KhachHang kh)
        {
            ...
            try
            {
                ...
                {
                    string updateKHQuerry = "UPDATE KHACHHANG SET TENKH = N'" + kh.TenKH + "', NGSINH = '" + kh.NgSinhKH.ToShortDateString() + "', GIOITINH = N'" + kh.GioiTinhKH + "',SDTKH = " + kh.SdtKH + ",DOANHSO =" + kh.DoanhSoKH +",IMAGEKH =N'" + kh.FileAnh + "' WHERE MAKH = " + kh.MaKH;
        ...
        static public bool xoaKhachHang(int ma)
        {
            ...
            try
            {
                string deleteKHQuerry = "DELETE FROM KHACHHANG WHERE MAKH = " + ma;
